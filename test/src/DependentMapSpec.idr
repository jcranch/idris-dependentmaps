...
tests = [
  ...
  lookup 5 m1 == Nothing,
  map trail (insertAndReport 1 [0] m1) == (True, [(1,0),(2,2),(3,3),(4,4)]),
  map trail (insertAndReport 2 [0,0] m1) == (False, [(2,0),(3,3),(4,4)]),
  map trail (insertAndReport 3 [0,0,0] m1) == (False, [(2,2),(3,0),(4,4)]),
  map trail (insertAndReport 4 [0,0,0,0] m1) == (False, [(2,2),(3,3),(4,0)]),
  map trail (insertAndReport 5 [0,0,0,0,0] m1) == (True, [(2,2),(3,3),(4,4),(5,0)]),
...
main : IO ()
main = putStrLn $ if and tests then "All tests passed!" else "Some failures."
